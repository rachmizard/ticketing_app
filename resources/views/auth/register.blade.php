        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form action="{{ route('register') }}" method="POST" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" @if($errors->has('password_confirmation')) data-validate = "{$errors->first('password_confirmation')}" @else data-validate = "Password is required" @endif>
...
<!--===============================================================================================-->  
    <script src="{{asset('vendor/jquery/jquery-3.2.1.min.j')}}s"></script>
<!--===============================================================================================-->
