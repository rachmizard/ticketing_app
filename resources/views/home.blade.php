              ...
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong>{{ $customers->count() }}</strong></span>
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs">{{$rutes->count()}}</strong></span>
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers">{{$reservations->count()}}</strong></span>
