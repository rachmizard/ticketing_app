<?php $__env->startSection('content'); ?>
           <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none">Data Grafik</h3>
              ...
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong><?php echo e($customers->count()); ?></strong></span>
                      <small class="text-muted text-uc">Jumlah Customer</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs"><?php echo e($rutes->count()); ?></strong></span>
                      <small class="text-muted text-uc">Rute Tersedia</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers"><?php echo e($reservations->count()); ?></strong></span>
                      <small class="text-muted text-uc">Reservasi</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
