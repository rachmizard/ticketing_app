...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap.cs')); ?>s" type="text/css" />
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/js/datepicker/datepicker.css')); ?>" type="text/css" />
  <link rel="stylesheet" href="<?php echo e(asset('/js/slider/slider.css')); ?>" type="text/css" />
...
<body>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="thumb-sm avatar pull-left">
              ...
              <?php else: ?>
              <img src="/img/<?php echo e(Auth::user()->photo); ?>" width="50" height="50">
              <?php endif; ?>
            </span>
  ...
  <script src="<?php echo e(asset('/js/slimscroll/jquery.slimscroll.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/charts/easypiechart/jquery.easy-pie-chart.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/sparkline/jquery.sparkline.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/flot/jquery.flot.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/flot/jquery.flot.tooltip.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/flot/jquery.flot.resize.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/flot/jquery.flot.grow.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/charts/flot/demo.js')); ?>"></script>

  <script src="<?php echo e(asset('/js/calendar/bootstrap_calendar.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/calendar/demo.js')); ?>"></script>

  <script src="<?php echo e(asset('/js/sortable/jquery.sortable.j')); ?>s"></script>
  <!-- parsley -->
  ...
  <!-- slider -->
  <script src="<?php echo e(asset('/js/slider/bootstrap-slider.js')); ?>"></script>
  <!-- file input -->  
  <script src="<?php echo e(asset('/js/file-input/bootstrap-filestyle.min.js')); ?>"></script>
  <!-- combodate -->
  <script src="<?php echo e(asset('/js/libs/moment.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/combodate/combodate.js')); ?>"></script>
  <!-- select2 -->
  <script src="<?php echo e(asset('/js/select2/select2.min.js')); ?>"></script>
  <!-- wysiwyg -->
  <script src="<?php echo e(asset('/js/wysiwyg/jquery.hotkeys.j')); ?>s"></script>
  <script src="<?php echo e(asset('/js/wysiwyg/bootstrap-wysiwyg.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/wysiwyg/demo.js')); ?>"></script>
  <!-- markdown -->
  <script src="<?php echo e(asset('/js/markdown/epiceditor.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/markdown/demo.js')); ?>"></script>
  <!-- datatables -->
