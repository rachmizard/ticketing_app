      ...
      <div class="modal-body">
        <form action="/admin/reservation" data-validate="parsley" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="reservation_code" class="form-control" id="reservation_code" placeholder="Reservation code" value="<?php echo e(rand()); ?>" data-required="true">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select id="select2-option-rute" class="form-control" id="rute_id" name="rute_id" placeholder="Rute" data-required="true">
              ...
              <?php $__currentLoopData = $rutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($rute->id); ?>"><?php echo e($rute->rute_from); ?> to <?php echo e($rute->rute_to); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>       
        <div class="form-group">
